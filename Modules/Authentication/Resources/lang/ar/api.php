...
return [
    "status"=>[
        "not_active" => "المستختدم محضظور من قبل الاداره",
        "not_admin_verified" => "المستختدم لم يتم تاكيده من قبل الاداره",
        "not_verified"       => "المتسخدم لم يتم توثيق حسابه بعد"
    ...
    'register'          => [
        'messages'      => [
            ...
            "already_verified"=> "الجوال تم تاكيد بالفعل من قبل"
        ],
        'validation'    => [
            'email'     => [
                'email'     => 'من فضلك ادخل البريد بشكل صحيح',
